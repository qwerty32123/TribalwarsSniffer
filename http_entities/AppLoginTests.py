...
login_elements = {'btn_guest_play': 'air.com.innogames.staemme:id/btn_guest_play',
                  ...
                  'server_selection': 'air.com.innogames.staemme:id/btn_welcome_world',
...
class LoginTests(unittest.TestCase):
    ...
    desired_caps['app'] = r'C:\Users\qwert\PycharmProjects\tribalwars\apk\Tribal Wars_v3.03.7_apkpure.com.apk'
    ...
    def app_on_game_init(self):
        try:
            ...
            map_nav_btn = self.driver.find_element_by_id(navigation_elements['map'])
            acc_nav_btn = self.driver.find_element_by_id(navigation_elements['account'])
            game_nav_btn = self.driver.find_element_by_id(navigation_elements['game'])
            menu_nav_btn = self.driver.find_element_by_id(navigation_elements['menu'])
            quest_nav_btn = self.driver.find_element_by_id(navigation_elements['quest'])
    ...
    def test_01_find_Account_btn(self):
        ...
        account_play_btn = self.driver.find_element_by_id(login_elements['account_play'])
    ...
    def test_03_search_server_btn(self):
        ...
        server_selection = self.driver.find_element_by_id(login_elements['server_selection'])
    ...
    def test_04_click_serverchoose_btn(self):
        ...
        cancel_bar = self.driver.find_element_by_id(login_elements['cancel_bar'])
    ...
    def test_05_click_server(self):
        ...
        servers = self.driver.find_elements_by_class_name('android.widget.TextView')
        for p in servers:
        ...
        with self.assertRaises(NoSuchElementException):
            self.driver.find_element_by_id(login_elements['select_version_bar'])
    ...
    def test_06_click_login_choose_btn(self):
        ...
        login_btn = self.driver.find_element_by_id(login_elements['login'])
        login_btn.click()

        WebDriverWait(self.driver, 30).until(EC.presence_of_element_located((By.ID, login_elements['password_input'])))
        pswd_input = self.driver.find_element_by_id(login_elements['password_input'])
    ...
    def test_07_input_user(self):
        WebDriverWait(self.driver, 30).until(EC.presence_of_element_located((By.ID, login_elements['password_input'])))
        user_input = self.driver.find_element_by_id(login_elements['username_input'])
        user_input.clear()
    ...
    def test_08_input_password(self):
        ...
        passw_input = self.driver.find_element_by_id(login_elements['password_input'])
        passw_input.clear()
    ...
    def test_09_perform_login(self):
        ...
        login = self.driver.find_element_by_id(login_elements['login_btn'])
        login.click()
        WebDriverWait(self.driver, 30).until(EC.presence_of_element_located((By.ID, login_elements['back_arrow_btn'])))
        with self.assertRaises(NoSuchElementException):
            self.driver.find_element_by_id(login_elements['username_input'])
        arrow_button = self.driver.find_element_by_id(login_elements['back_arrow_btn'])
    ...
    def test_10_enter_world(self):
        ...
        map_acces_button = self.driver.find_element_by_id(login_elements['map_navigation'])
    ...
    def test_15_quests_nav_btn(self):
        self.assertTrue(self.app_on_game_init())
        quests_nav_btn = self.driver.find_element_by_id(navigation_elements['quest'])
        quests_nav_btn.click()
        self.assertTrue(quests_nav_btn.is_selected())

    def test_16_account_nav_btn(self):
        self.assertTrue(self.app_on_game_init())
        account_nav_btn = self.driver.find_element_by_id(navigation_elements['account'])
        account_nav_btn.click()
        WebDriverWait(self.driver, 30).until(EC.presence_of_element_located((By.ID, ingame_elements['btn_exit'])))
        logout_btn = self.driver.find_element_by_id(ingame_elements['btn_exit'])
    ...
    def test_17_check_menu_elements(self):
        ...
        menu = self.driver.find_element_by_id(menu_elements['menu_buttons_container'])
        all_menu_bubttons = menu.find_elements_by_class_name('android.view.ViewGroup')
    ...
    def test_18_check_headquarters(self):
        ...
        for p in all_menu_bubttons:
            name = p.find_element_by_class_name("android.widget.TextView")
        ...
        headquarter_inside_element = self.driver.find_element_by_id(ingame_elements['rcl_headquarters'])
        self.assertTrue(headquarter_inside_element.is_displayed())
    def test_19_try_to_build(self):
        self.app_on_game_init()
        WebDriverWait(self.driver, 30).until(EC.presence_of_element_located((By.ID, ingame_elements['rcl_headquarters'])))
        all_view_groups = self.driver.find_elements_by_class_name('android.view.ViewGroup')
        count = 0
        for p in all_view_groups:
            name = p.find_elements_by_class_name("android.widget.TextView")
            for z in name:
    ...
    def test_20_attack_barbarian(self):
        ...
        inputx = self.driver.find_element_by_id(rally_point_elements['target_x'])
        inputy = self.driver.find_element_by_id(rally_point_elements['target_y'])
        inputy.clear()
        inputx.clear()
        inputx.send_keys(self.target_x)
        inputy.send_keys(self.target_y)
        #we input amount of units
        inputsword = self.driver.find_element_by_id(rally_point_elements['sword_input'])
        inputspear = self.driver.find_element_by_id(rally_point_elements['spear_input'])
        inputspear.clear()
        inputsword.clear()
        ...
        entire_form =  self.driver.find_element_by_id(rally_point_elements['form'])
        rally_views = entire_form.find_elements_by_class_name('android.view.ViewGroup')
        for p in rally_views:
            name = p.find_element_by_class_name("android.widget.Button")
            if name.text == 'Attack':
                p.click()
                break
        WebDriverWait(self.driver, 30).until(EC.presence_of_element_located((By.ID, rally_point_elements['arrival_time'])))
        arrival_time = self.driver.find_element_by_id(rally_point_elements['arrival_time'])
    ...
    def test_21_send_attack(self):
        self.assertTrue(self.app_on_game_init())
        WebDriverWait(self.driver, 30).until(EC.presence_of_element_located((By.ID, rally_point_elements['arrival_time'])))
        all_buttons = self.driver.find_elements_by_class_name('android.widget.Button')
        ...
        all_buttons = self.driver.find_elements_by_class_name('android.view.View')
    ...
    def load_menu_ids(self,buttons):
        for p in buttons:
            text = p.find_element_by_class_name("android.widget.TextView")
