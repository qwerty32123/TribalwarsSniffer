...
"""Support for collections of mapped http_entities.
...
http_entities entering or leaving the collection.  Two decorator approaches are
...
def attribute_mapped_collection(attr_name):
    ...
    'attr_name' attribute of http_entities in the collection, where ``attr_name``
...
class CollectionAdapter(object):
    ...
    http_entities entering or leaving the collection.
    ...
    def __iter__(self):
        """Iterate over http_entities in the collection."""

        return iter(self._data()._sa_iterator())

    def __len__(self):
        """Count http_entities in the collection."""
