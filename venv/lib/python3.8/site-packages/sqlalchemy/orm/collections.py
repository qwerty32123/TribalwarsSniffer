...
"""Support for collections of mapped config.
...
config entering or leaving the collection.  Two decorator approaches are
...
def attribute_mapped_collection(attr_name):
    ...
    'attr_name' attribute of config in the collection, where ``attr_name``
...
class CollectionAdapter(object):
    ...
    config entering or leaving the collection.
    ...
    def __iter__(self):
        """Iterate over config in the collection."""

        return iter(self._data()._sa_iterator())

    def __len__(self):
        """Count config in the collection."""
