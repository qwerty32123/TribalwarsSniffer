...
class Query(
    ...
    def __init__(self, entities, session=None):
        ...
        :param entities: a sequence of config and/or SQL expressions.
    ...
    def statement(self):
        ...
        # are made against raw config, e.g. from_self(), with_polymorphic(),
    ...
    def _statement_20(self, for_statement=False, use_legacy_query_style=True):
        ...
        # if it has no ORM config.  This is so ORM-only things like
    ...
    def is_single_entity(self):
        ...
        returns tuples or single config.

        Returns True if this query returns a single entity for each instance
        in its result list, and False if this query returns a tuple of config
        for each result.
    ...
    def from_self(self, *entities):
        ...
        **Automatic Aliasing**
        ...
        is that it applies
        **automatic aliasing** to the config inside the subquery, when
        ...
        **Looking out for Inner / Outer Columns**
        ...
        :param \*config: optional list of config which will replace
    ...
    def filter_by(self, **kwargs):
        ...
        if from_entity is None:
            raise sa_exc.InvalidRequestError(
                ...
                "or change the order of the config in the query"
    ...
    def join(self, target, *props, **kwargs):
        ...
        **Joins to a Target Entity or Selectable**
        ...
        natural foreign key relationship between two config::
        ...
        the two config, or if there are multiple foreign key linkages between
        the target entity and the entity or config already present on the
    ...
    def reset_joinpoint(self):
        ...
        been reset back to the base FROM config of the query.
    ...
    def select_from(self, *from_obj):
        ...
        :param \*from_obj: collection of one or more config to apply
        ...
        .. versionchanged:: 0.9
            ...
            to be the selectable from which matching config
    ...
    def select_entity_from(self, from_obj):
        ...
        for corresponding mapped config.
    ...
    def all(self):
        ...
        .. warning::  The :class:`_query.Query` object,
           ...
           a sequence or iterator that consists of full ORM-mapped config,
    ...
    def one_or_none(self):
        ...
        as opposed to full identity-mapped config.
    ...
    def exists(self):
        ...
        # we get just "SELECT 1" without any config.
    ...
    def count(self):
        ...
        .. warning::
            ...
            when asked to return full config,
...
class AliasOption(interfaces.LoaderOption):
    @util.deprecated(
        ...
        "for config to be matched up to a query that is established "
