...
class Query(
    ...
    def __init__(self, entities, session=None):
        ...
        :param entities: a sequence of http_entities and/or SQL expressions.
    ...
    def statement(self):
        ...
        # are made against raw http_entities, e.g. from_self(), with_polymorphic(),
    ...
    def _statement_20(self, for_statement=False, use_legacy_query_style=True):
        ...
        # if it has no ORM http_entities.  This is so ORM-only things like
    ...
    def is_single_entity(self):
        ...
        returns tuples or single http_entities.

        Returns True if this query returns a single entity for each instance
        in its result list, and False if this query returns a tuple of http_entities
        for each result.
    ...
    def from_self(self, *entities):
        ...
        **Automatic Aliasing**
        ...
        is that it applies
        **automatic aliasing** to the http_entities inside the subquery, when
        ...
        **Looking out for Inner / Outer Columns**
        ...
        :param \*http_entities: optional list of http_entities which will replace
    ...
    def filter_by(self, **kwargs):
        ...
        if from_entity is None:
            raise sa_exc.InvalidRequestError(
                ...
                "or change the order of the http_entities in the query"
    ...
    def join(self, target, *props, **kwargs):
        ...
        **Joins to a Target Entity or Selectable**
        ...
        natural foreign key relationship between two http_entities::
        ...
        the two http_entities, or if there are multiple foreign key linkages between
        the target entity and the entity or http_entities already present on the
    ...
    def reset_joinpoint(self):
        ...
        been reset back to the base FROM http_entities of the query.
    ...
    def select_from(self, *from_obj):
        ...
        list of http_entities to be selected.
        ...
        :param \*from_obj: collection of one or more http_entities to apply
        ...
        .. versionchanged:: 0.9
            ...
            to be the selectable from which matching http_entities
    ...
    def select_entity_from(self, from_obj):
        ...
        for corresponding mapped http_entities.
    ...
    def all(self):
        ...
        .. warning::  The :class:`_query.Query` object,
           ...
           a sequence or iterator that consists of full ORM-mapped http_entities,
    ...
    def one_or_none(self):
        ...
        as opposed to full identity-mapped http_entities.
    ...
    def exists(self):
        ...
        # we get just "SELECT 1" without any http_entities.
    ...
    def count(self):
        ...
        .. warning::
            ...
            when asked to return full http_entities,
...
class AliasOption(interfaces.LoaderOption):
    @util.deprecated(
        ...
        "for http_entities to be matched up to a query that is established "
