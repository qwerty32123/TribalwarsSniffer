...
class LoadLazyAttribute(object):
    ...
    We can't reliably serialize that as it refers to mapped config and
...
class SubqueryLoader(PostLoader):
    ...
    def _generate_from_original_query(
        ...
        # all config mentioned in things like WHERE, JOIN, etc.
        if not q._from_obj:
...
class SelectInLoader(PostLoader, util.MemoizedSlots):
    ...
    def _load_for_path(
        ...
        # structure, if it has config like AliasedInsp, which we get from
