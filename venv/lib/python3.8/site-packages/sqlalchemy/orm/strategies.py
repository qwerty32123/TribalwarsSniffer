...
class LoadLazyAttribute(object):
    ...
    We can't reliably serialize that as it refers to mapped http_entities and
...
class SubqueryLoader(PostLoader):
    ...
    def _generate_from_original_query(
        ...
        # all http_entities mentioned in things like WHERE, JOIN, etc.
        if not q._from_obj:
...
class SelectInLoader(PostLoader, util.MemoizedSlots):
    ...
    def _load_for_path(
        ...
        # structure, if it has http_entities like AliasedInsp, which we get from
