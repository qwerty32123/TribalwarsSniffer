...
class Select(
    ...
    def _create(cls, *args, **kw):
        ...
        .. versionadded:: 2.0 - the :func:`_future.select` construct is
           ...
           accepts the "columns clause" http_entities up front; the rest of the
    ...
    def from_statement(self, statement):
        ...
        columns appropriate to the http_entities represented by this
        :class:`.Select`.
